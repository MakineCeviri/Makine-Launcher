...
ColumnLayout {
    ...
    SettingsCard {
        ...
        ColumnLayout {
            ...
            Item {
                Layout.fillWidth: true
                Layout.preferredHeight: _cbCol.implicitHeight + 2 * Dimensions.marginML

                ColumnLayout {
                    id: _cbCol
                    anchors.left: parent.left; anchors.right: parent.right
                    anchors.verticalCenter: parent.verticalCenter
                    anchors.leftMargin: Dimensions.marginML; anchors.rightMargin: Dimensions.marginML
                    ...
                    RowLayout {
                        ...
                        Rectangle {
                            implicitWidth: _a11yLbl.implicitWidth + 12
                            implicitHeight: 18; radius: Dimensions.radiusFull
                            color: "#3b82f622"; border.color: "#3b82f644"; border.width: 1

                            Label {
                                id: _a11yLbl; textFormat: Text.PlainText
                                anchors.centerIn: parent; text: qsTr("Erişilebilirlik")
                    ...
                    Flow {
                        ...
                        Repeater {
                            model: SettingsManager.colorBlindModes()

                            Rectangle {
                                required property var modelData
                                required property int index
                                implicitWidth: _cbModeLbl.implicitWidth + 24
                                implicitHeight: 34
                                radius: Dimensions.radiusMD
                                color: SettingsManager.colorBlindMode === modelData.id
                                    ? Theme.primary20
                                    : _cbModeMouse.containsMouse ? Theme.primary08 : Theme.primary04
                                border.color: SettingsManager.colorBlindMode === modelData.id
                                    ? Theme.primary40 : "transparent"
                                border.width: 1
                                ...
                                Label {
                                    ...
                                    font.weight: SettingsManager.colorBlindMode === modelData.id ? Font.DemiBold : Font.Medium
                                    color: SettingsManager.colorBlindMode === modelData.id ? Theme.primary : Theme.textSecondary
                                }

                                ToolTip {
                                    visible: _cbModeMouse.containsMouse
                                ...
                                MouseArea {
                                    ...
                                    hoverEnabled: true
                                    cursorShape: Qt.PointingHandCursor
                                    onClicked: SettingsManager.colorBlindMode = modelData.id
                                }
                            }
                        }
                    }
