/**
 * @file config.hpp
 * @brief MakineAI configuration system
 * @copyright (c) 2026 MakineAI Team
 *
 * Provides centralized configuration management for all MakineAI components.
...
struct NetworkConfig {
    ...
    /// User agent string
    std::string userAgent = "MakineAI/0.1.0";
...
struct DatabaseConfig {
    /// Database file path
    std::string databasePath = "makineai.db";
...
struct CoreConfig {
    ...
    std::string apiBaseUrl = "https://api.makineai.com/v1";
