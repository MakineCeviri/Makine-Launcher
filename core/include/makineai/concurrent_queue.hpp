 ...
 * - MAKINEAI_HAS_CONCURRENTQUEUE - moodycamel::ConcurrentQueue available
 *
...
public:
    ...
    void close() {
        closed_ = true;
#ifndef MAKINEAI_HAS_CONCURRENTQUEUE
        cv_.notify_all();
#endif
    }
...
#endif // MAKINEAI_HAS_CONCURRENTQUEUE
